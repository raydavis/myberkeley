...
public class ForeignPrincipalFilter implements Filter {
  ...
  public static final String[] DEFAULT_EXTERNAL_AUTH_TYPES = {"CAS", "SAML"};
  @Property(label = "External Authentication Types",
      description = "Supported authentication types as returned from ServletRequest getAuthType; for example, 'CAS' or 'SAML'")
  public static final String EXTERNAL_AUTH_TYPES = "foreignprincipal.auth.types";
  private String[] externalAuthTypes;
  ...
  public void doFilter(ServletRequest req, ServletResponse resp, FilterChain chain)
    ...
    if ((authType != null) && (remoteUser != null) && !("anonymous".equals(remoteUser))) {
      ...
      LOGGER.debug("remoteUser = {}, authType = {}, userPrincipal = {}, attributes = {}",
          new Object[] {remoteUser, authType, request.getUserPrincipal(), attributeNames});
      if (Arrays.asList(externalAuthTypes).contains(authType)) {
  ...
  protected void activate(Map<?, ?> props) {
    externalAuthTypes = PropertiesUtil.toStringArray(props.get(EXTERNAL_AUTH_TYPES), DEFAULT_EXTERNAL_AUTH_TYPES);
    ...
    LOGGER.debug("externalAuthTypes = {}, foreignPrincipalHandlerPath = {}", externalAuthTypes, foreignPrincipalHandlerPath);
  }
}
